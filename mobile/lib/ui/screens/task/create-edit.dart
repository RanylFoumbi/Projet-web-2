...
class _CreateAndEditTaskState extends State<CreateAndEditTask> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    const SizedBox(height: xsSpacer),
                    CustomDropdown(
                      items: const ['TODO', 'DOING', 'DONE', 'CANCELLED'],
  ...
  createTask() async {
    ...
    Navigator.of(context)
      ...
      MaterialPageRoute(
        ...
        .then((value) {
      clearForm();
      showsnackbar(context, "Tâche créée avec succès");
    });
  }
  ...
  updateTask() async {
    ...
    TaskService().updateTask(widget.task!.id!, task);
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => const Home(),
      ),
    );
    showsnackbar(context, "Tâche mise à jour avec succès");
  }
}
